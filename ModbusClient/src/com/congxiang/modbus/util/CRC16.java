...
public class CRC16 {
	...
	public static void main(String[] args) {
		...
		// 01030000000AC5CD
		// int crc = CRC16.calcCrc16(new byte[] { 0x02, 0x05, 0x00, 0x03, (byte)
		// 0xff, 0x00 }); (byte)
		// int crc = CRC16.calcCrc16(new byte[] { 0x01, 0x03, 0x00, 0x00, 0x00, 0x0A });
		
		//0xF0 ,0x00 ,0x15 ,0x01 ,0x00 ,0x6A ,0x7A ,0x71 ,0x30 ,0x30 ,0x31 ,0x20 ,0x16 ,0x04 ,0x01 ,0x11 ,0x03 ,0x46
		//int crc = CRC16.calcCrc16(new byte[] {(byte) 0xF0 ,0x00 ,0x15 ,0x01 ,0x00 ,0x6A ,0x7A ,0x71 ,0x30 ,0x30 ,0x31 ,0x20 ,0x16 ,0x04 ,0x01 ,0x11 ,0x03 ,0x46});
		int crc = CRC16.calcCrc16(new byte[] {(byte) 0x02 ,0x03 ,0x04 ,(byte)0xA4 ,(byte)0x70 ,(byte)0xBB ,0x41 ,(byte)0x8B ,(byte)0x10 ,(byte)0xFF ,0x41 });

		System.out.println(String.format("0x%04x", crc).toUpperCase());
